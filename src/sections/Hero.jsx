...
export default function Hero(){
    return (
     ...
     <div className="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
      ...
      <p className="mt-4 text-base text-pretty text-gray-700 sm:text-lg/relaxed dark:text-gray-300">
      ...
      <div className="flex justify-center bg-orange-500  items-center gap-1 mt-4  text-pretty text-gray-700 sm:text-lg/relaxed dark:text-gray-200 border px-3 py-1 max-w-fit mx-auto rounded-md animate-bounce">
