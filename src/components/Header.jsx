        ...
        <nav aria-label="Global">
          <ul className="flex items-center gap-6 text-md font-medium">
            <li className='flex justify-center items-center gap-1'>
               <a className="text-black transition hover:text-white" href="#"> Cohorts </a>
               {/* red dot Pulsing */}
            ...
            <li>
              <a className="text-black transition hover:text-white" href="#"> Udemy </a>
            </li>

            <li>
              <a className="text-black transition hover:text-white" href="#"> Docs </a>
            </li>

            <li>
              <a className="text-black transition hover:text-white" href="#"> Reviews </a>
            </li>
          </ul>
        </nav>
      </div>
